            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/students') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                            ...
                            <table class="table">
                                ...
                                @foreach($students as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/students/' . $item->id) }}" title="View Student"><button class="btn btn-warning btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>

                                            <a href="{{ url('/students/' . $item->id . '/edit') }}" title="Edit Student"><button class= "btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
