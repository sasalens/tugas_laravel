                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Dosen </th><td> {{ $schedule->user->name }} </td></tr><tr><th> Group </th><td> {{ $schedule->group->name }} </td></tr><tr><th> Note </th><td> {{ $schedule->note }} </td></tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Student</th><th>Note</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($schedule->presences as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->student->name }}</td><td>{{ $item->note }}</td>
                                        <td>
